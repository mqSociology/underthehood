...
Also, Netlify won't deploy the website if you link to an internal page that doesn't exist. This can happen when you delete a page that is being linked to or you type a page in wrong. 
